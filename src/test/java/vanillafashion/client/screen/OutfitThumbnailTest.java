...
class OutfitThumbnailTest {
    ...
    @Test void gridHasOnlyTwoDimensionalTextureSubmissionAndNoLegacySampleOrResourceOwner() throws Exception {
        ...
        String widget = Files.readString(root.resolve("src/client/java/vanillafashion/client/screen/OutfitGridEntryWidget.java"));
        String plan = Files.readString(root.resolve("src/client/java/vanillafashion/client/screen/OutfitThumbnail.java"));
