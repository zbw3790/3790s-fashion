...
import vanillafashion.client.render.PlayerFashionRenderAppearance;
import vanillafashion.client.render.PlayerFashionRenderState;
...
class WardrobePreviewConfigurationTest {
	private static final Identifier CAPE = Identifier.fromNamespaceAndPath("vanilla_fashion", "test/cape");
	private static final Identifier ELYTRA = Identifier.fromNamespaceAndPath("vanilla_fashion", "test/elytra");
