...
class CapeSelectionPayloadTest {
	...
	void fieldsContainNoTargetUuidOrAssetData() {
		...
		assertEquals("fashion_3790:set_cape_selection", SetCapeSelectionPayload.TYPE.id().toString());
		assertEquals("fashion_3790:cape_selection_result", CapeSelectionResultPayload.TYPE.id().toString());
	}
