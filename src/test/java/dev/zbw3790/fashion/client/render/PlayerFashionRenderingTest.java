...
class PlayerFashionRenderingTest {
	...
	private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("fashion_3790", "test/cape");
	private static final Identifier WINGS = Identifier.fromNamespaceAndPath("fashion_3790", "test/wings");
