...
class CapeSelectionHandlerTest {
    ...
    @Test void v2RouteCannotUseLegacyWriteOrReceiveLegacyResult() {
        ...
        var result=CapeSelectionHandler.process(FIRST,new SetCapeSelectionPayload(1,Optional.of(BUILDER)),Optional.of(service),FashionAuthorityRoute.V4,true,true);
