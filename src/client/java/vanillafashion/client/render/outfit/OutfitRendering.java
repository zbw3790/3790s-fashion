...
public final class OutfitRendering {
    private static final Logger LOGGER = LoggerFactory.getLogger("vanilla_fashion/outfit_rendering");
    ...
    private static final RenderStateDataKey<Frame> KEY = RenderStateDataKey.create(() -> "vanilla_fashion:outfit");
