...
public final class OutfitSpikeHarness {
    public static final String ENABLE_PROPERTY = "vanilla_fashion.outfitSpike";
    public static final String DIRECTORY_PROPERTY = "vanilla_fashion.outfitSpikeDirectory";
    private static final Logger LOGGER = LoggerFactory.getLogger("vanilla_fashion/outfit_spike");
        ...
        for (String model : new String[]{"wide", "slim"}) {
            for (String role : new String[]{"all", "head", "upper", "left", "transparent", "alpha", "mismatch"}) {
                ...
                try {
                    ...
                    Identifier id = Identifier.fromNamespaceAndPath("vanilla_fashion", "outfit_spike/" + name);
