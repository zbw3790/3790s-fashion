...
import dev.zbw3790.fashion.outfit.OutfitId;
...
final class OutfitGridEntryWidget extends AbstractButton {
    ...
    boolean dimmed() { return content.source.availability(id)!=dev.zbw3790.fashion.client.outfit.ClientOutfitTextureResolver.Availability.READY; }
