...
public final class ClientOutfitTextureManager {
    ...
    public static Identifier identifierFor(String hash) { return Identifier.fromNamespaceAndPath("fashion_3790","outfit_asset/"+CapeAssetHash.requireValid(hash,"装束纹理 hash ")); }
    ...
    public static Backend minecraft(TextureManager manager) {
        return (id,bytes) -> {
            ...
            try {
                ...
                texture=new DynamicTexture(() -> "3790's Fashion 装束运行时纹理",image); image=null;
