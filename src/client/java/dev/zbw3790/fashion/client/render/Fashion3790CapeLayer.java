...
public final class Fashion3790CapeLayer extends RenderLayer<AvatarRenderState, PlayerModel> {
	private final PlayerCapeModel model;
	private final EquipmentAssetManager equipmentAssets;

	public Fashion3790CapeLayer(
	...
	public void submit(
		...
		if (!shouldTakeOverCape
				...
				|| ElytraSlotVisualCooperation.blocksCape(state)) {
			return;
		}
