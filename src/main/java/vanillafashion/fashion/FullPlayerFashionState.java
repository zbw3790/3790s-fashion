...
import vanillafashion.outfit.OutfitPartSelection;
...
public record FullPlayerFashionState(PlayerFashionStoredState stored, PlayerFashionEffectiveState effective, long revision) {
    ...
    public static FullPlayerFashionState defaults(long revision) {
        return new FullPlayerFashionState(PlayerFashionStoredState.DEFAULT, new PlayerFashionEffectiveState(java.util.Optional.empty(), vanillafashion.outfit.OutfitSelections.original()), revision);
    }
