...
import dev.zbw3790.fashion.network.ServerPayloadSender;
...
public final class WardrobeInteractionHandler {
    ...
    public static InteractionResult afterVanilla(Player player, Entity target, InteractionResult finalResult) {
        ...
        return fallback(finalResult,candidate,player.level().isClientSide(),Fashion3790.wardrobeServerAvailability().isAvailable(),
