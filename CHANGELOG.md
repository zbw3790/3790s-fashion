...
- 接入四张人工绘制衣柜图标；披风页签与披风预览按钮共用同一图标。
- 完善简体中文／英文界面及命令反馈，中央悬停提示避让、长提示 PageUp／PageDown 阅读和双语入门。
- Cape、Outfit、Armor、统一 Apply 与资源同步／热重载沿用已有功能，不新增装备或玩法。
- 正式 0.5.0 与 1.0.0 同为 schema 4／Full v4；升级前正常停服并备份完整世界与配置，回退恢复完整备份。
- 固定附属的世界与主动试穿支持保持；原版物品栏 BODY 翼／披风遮挡缺口及真实 BODY 组合预览继续后置。
